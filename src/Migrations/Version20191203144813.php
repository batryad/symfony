 ...
 */
final class Version20191203144813 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE program ADD category_id INT NOT NULL, ADD summary LONGTEXT NOT NULL, ADD poster VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE program DROP category_id, DROP summary, DROP poster');
    }
}
